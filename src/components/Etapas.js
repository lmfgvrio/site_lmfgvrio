  ...
  return (
    ...
    {/* Aqui vocês conseguem atualizar as etapas do processo seletivo (mudar apenas textos em branco) */}
      ...
      <p>
        ...
        <br />
        <br />
        Os trainees aprovados no processo seletivo recebem uma apostila exclusiva da liga para aprofundar seus conhecimentos
        sobre o mercado financeiro. Além disso, a LMF organiza palestras e visitas estratégicas a instituições do setor,
        proporcionando uma experiência prática e o contato direto com profissionais da área.
        <br />
        <br />
        ...
        <br />
        <br />
        Na última etapa, os trainees aplicam todo o conhecimento adquirido para analisar uma empresa listada em bolsa dentro do
        setor previamente estudado. O objetivo é compreender em profundidade seus demonstrativos financeiros e, por fim,
        realizar um valuation para embasar uma tese de investimento.
        <br />
        <br />
